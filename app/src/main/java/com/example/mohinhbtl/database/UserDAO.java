...
public interface UserDAO {
    ...
    @Query("SELECT * FROM user where cccd like '%' ||  :name || '%' or address like '%' ||  :name || '%' ")
...
//    String countUser(String checkdate);
    @Query("select count(id) from user where date like '%' || :checkdate || '%' ")
    String countDate(String checkdate);

    @Query("select count(id) from user where cccd like '%' || :checkdate || '%' or address like '%' || :checkdate || '%' ")
    String countUser(String checkdate);
